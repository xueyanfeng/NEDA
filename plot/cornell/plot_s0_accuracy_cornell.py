...
ax1.text(0.5+x_max,y_max-0.001,"({:.0f}, {:.2f})".format(x_max, 100*y_max),fontsize=18)
...
ax1.text(0.5+x_min,y_min-0.001,"({:.0f}, {:.2f})".format(x_min, 100*y_min),fontsize=18)
...
ax1.annotate('top-10', xy=(5, top10), xytext=(7.5, top10 + 0.01),size=18,
...
ax2.text(0.5+x_max,y_max-0.001,"({:.0f}, {:.2f})".format(x_max, 100*y_max),fontsize=18)
...
ax2.text(0.5+x_min, y_min-0.001,"({:.0f}, {:.2f})".format(x_min, 100*y_min),fontsize=18)
plt.title('NEDA*',fontsize=22)
...
ax2.annotate('top-10', xy=(5, top10), xytext=(7.5, top10 + 0.01), size=18,
            arrowprops=dict(facecolor='g', shrink=0.01))
plt.xlabel(r'$s_{0}$',fontsize=24)
